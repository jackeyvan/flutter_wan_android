...
import 'package:flutter_wan_android/app/modules/entity/score_rank_list_entity.dart';
...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<ArticleDatas>[] is M) {
      return data
          .map<ArticleDatas>(
              (Map<String, dynamic> e) => ArticleDatas.fromJson(e))
          .toList() as M;
    }
    if (<ArticleDatasTags>[] is M) {
      return data
          .map<ArticleDatasTags>(
              (Map<String, dynamic> e) => ArticleDatasTags.fromJson(e))
          .toList() as M;
    }
