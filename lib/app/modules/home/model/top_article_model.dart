...
TopArticleModel fromJson(String str) =>
    TopArticleModel.fromJson(json.decode(str));
String toJson(TopArticleModel data) => json.encode(data.toJson());
...
class TopArticleModel {
  ...
  TopArticleModel.fromJson(dynamic json) {
